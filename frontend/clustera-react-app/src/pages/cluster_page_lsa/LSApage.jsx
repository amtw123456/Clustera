...
function LSApage() {
  ...
  const clusterUsingLsa = async () => {
    ...
    try {
      const response = await fetch(REACT_APP_BACKEND_API_URL + 'lsa', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const trainClassifier = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch(REACT_APP_BACKEND_API_URL + 'trainlsaclassifier', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
          ...
          isDataSummaryBool ? (
            <>
              ...
              <div className="flex justify-center mt-4">
                <button onClick={() => clusterUsingLsa()}>
                  {
                    isLoading ? (
