        ...
        {isPreProcessedBool > 0 ? (
          isLoading ? (
            ...
            responseInfo.length > 0 ? (
              ...
              <div class="flex-1">
                <div className="text-center mt-48 text-gray-600 text-base dark:text-gray-400">Documents have not yet been tokenized!</div>
          ...
          uploadedData.length > 0 ? (
            ...
            <div class="flex-1">
              <div className="text-center mt-48 text-gray-600 text-xl dark:text-gray-400">There are no Documents loaded yet to the page please Upload a JSON or CSV file.</div>
              <Link to="/"><div class="text-center text-blue-600 text-base underline-offset-4">Go to Upload Page</div></Link>
            </div>
          )
        }
